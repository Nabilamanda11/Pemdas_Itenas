...
print(df)
print("\nRingkasan: Peningkatan gaji sebesar 5% telah diberikan kepada setiap karyawan.")
...
print(df)
print("\nRingkasan: Peningkatan tambahan sebesar 2% telah diberikan kepada karyawan yang usianya di atas 30 tahun.")
